...
public class ProfileActivity extends android.app.Activity {
    ...
    try {
        ...
        if(PUsername.equals(CUsername)) {
            ...
            EditButton.setVisibility(View.GONE);
            final ParseQuery<Photo> FollowQuery = ParseQuery.getQuery("Activity");
...
//        Mention.setText("@" + ProfileUser.get("usernameFix").toString());
        ...
        //Get FollowerNumber
        ParseQuery<Photo> FollowerQuery = ParseQuery.getQuery("Activity");
        ...
        //Get FollowingNumber
        ParseQuery<Photo> FollowingQuery = ParseQuery.getQuery("Activity");
    ...
    public static ParseUser getUserWithUser(String UserID){
       //PhotoUser = NotificationAdapter.getUser();
