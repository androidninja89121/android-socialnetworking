...
public class ProfileAdapter extends ParseQueryAdapter<Photo> {
    ...
    public ProfileAdapter(Context context) {
        ...
        super(context, new ParseQueryAdapter.QueryFactory<Photo>() {
            ...
            public ParseQuery create() {
                ...
                ParseQuery<Photo> query = ParseQuery.or(Arrays.asList(photosFromCurrentUserQuery));
                query.include("user");
...
//                query.setCachePolicy(ParseQuery.CachePolicy.CACHE_THEN_NETWORK);
    ...
    private void shareImage(View v, Photo pPhoto) {
        ...
        String url = pPhoto.getImage().getUrl();
        Log.d("Log", "ULR = " + url);
        ...
        File imageFileToShare = new File(pPhoto);
